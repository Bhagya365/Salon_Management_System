        ...
        <div class="col-lg-12">
            <div class="card m-b-20">
                <div class="card-body">
                    ...
                    <form action="{{ route('appointmentReport') }}" method="get">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-2" style="padding-top: 28px">
                                ...
                                <!-- reset button -->
                                <a href="{{ route('appointmentReport') }}" class="btn btn-md btn-primary waves-effect" style="margin-left: 20px;">Clear</a>
                            </div>
                                ...
                                @if(isset($appointments))
                                    ...
                                    @else
                                        <tr>
                                            ...
                                            <td colspan="6" style="text-align: center;font-weight: bold  ">Sorry no results found. </td>
                                        </tr>
...
<script type="text/javascript">
     ...
     var reportTitle = @json($title . (!empty($filterText) ? ' - ' . $filterText : ''));
