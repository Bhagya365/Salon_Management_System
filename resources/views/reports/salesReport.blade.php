                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('salesReport') }}" method="get">
                        ...
                        <div class="row">
                                    ...
                                    @if(isset($clients))
                                        @foreach($clients as $client)
                                            <option value="{{ $client->idclient }}"
                                                @if(request('clientName') == $client->idclient) selected @endif>
                            ...
                            <!-- Search by Status -->
                            <div class="form-group col-md-4">
                                <select class="form-control select2" id="paytype" name="paytype">
                                    <option value="">Search by Payment</option>
                                    <option value="CASH" @if(request('paytype')=='CASH') selected @endif>CASH</option>
                                    <option value="CARD" @if(request('paytype')=='CARD') selected @endif>CARD</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group col-md-2" style="padding-top: 28px">
                                ...
                                <!-- reset button -->
                                <a href="{{ route('salesReport') }}" class="btn btn-md btn-primary waves-effect" style="margin-left: 20px;">Clear</a>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        // Select2 initialization (get top due to overite by class name)
        $('.select2').select2({
