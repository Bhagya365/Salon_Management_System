<header id="header">
    <div class="container-fluid">
        <div class="navbar">
            ...
            <a href="{{ URL::asset('clientInterface')}}" id="logo">
                <img src="{{ URL::asset('assets/images/logoRB.png')}}" height="100" alt="logo">
            </a>
                ...
                <nav id="navigation">
                    ...
                    <div class="nav-box navbar-collapse">
                        <ul class="navigation-menu nav navbar-nav navbars" id="nav">
                            ...
                            <li data-menuanchor="slide06"><a href="signin">Log In</a></li>
                            <li data-menuanchor="slide07"><a href="clientSignup">Sign Up</a></li>
                        </ul>
                    </div>
                </nav>
            </div>
