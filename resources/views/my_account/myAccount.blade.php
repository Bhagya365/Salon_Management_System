                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="contactNo readonly" autocomplete="off" name="contactNo" placeholder="+(94) XX XXX XXXX" readonly   value="{{$users->contact_number}}">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="my-input-id" id="my-input-id" required disabled>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="uName readonly" autocomplete="off" name="uName" placeholder="User Name" readonly value="{{$users->user_name}}">
                                <small class="text-danger" id="uNameError"></small>
                            </div>
            ...
            success:function(data){
                ...
                if (data.errors != null) {
                    ...
                    if(data.errors.uName){
                        var p = document.getElementById('uNameError');
                        p.innerHTML = data.errors.uName[0];
