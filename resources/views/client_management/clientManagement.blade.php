                                                ...
                                                <td>
                                                    ...
                                                    <p>
                                                        <button type="button" title="View"
                                                                ...
                                                                data-email="{{ $userClient->user_name }}"
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="dob"
                           name="dob" placeholder="Date of Birth" required max="<?php echo date('Y-m-d'); ?>">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="updateContactNo"
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" name="updateEmail"
                           id="updateEmail" required placeholder="User Name or Email"/>
